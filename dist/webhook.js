...
router.post("/github-webhook", (req, res) => {
    ...
    (0, child_process_1.exec)("cd /home/tresbedistribuidora/htdocs/api.tresbedistribuidora.com/Tresbe-Backend && git pull origin main && npm install --production && pm2 restart 1", (err, stdout, stderr) => {
        if (err) {
            console.error(err);
