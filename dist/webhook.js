...
router.post("/github-webhook", (req, res) => {
    ...
    (0, child_process_1.exec)("cd /home/tresbedistribuidora/htdocs/api.tresbedistribuidora.com/Tresbe-backend && git pull origin main && pm2 restart mi-backend", (err, stdout, stderr) => {
        if (err) {
            console.error(err);
